 ...
 <div class="content-header">
    ...
    <table class="table table-bordered table-stripped table-hover" id="example">
		...
		<tr class="nomor text-center">
            ...
            <td><?php echo anchor('home/editruangan/'.$data->id_ruang,'<div class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></div>')?> 
            <?php echo anchor('home/hapusruangan/'.$data->id_ruang,'<div  onclick="return kotak_hapus()" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>')?> </td>	
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <form method="post" action="<?php echo base_url().'home/tambahruangan'; ?>">
